...
var lastplayerlocation=[undefined,undefined];
...
function updatePlayer(){
    lastplayerlocation[0]=playerLocation[0];
    lastplayerlocation[1]=playerLocation[1];
    ...
    //console.log(playerLocation);
    //console.log(lastplayerlocation);
...
function updateEnemy(i){
    //if(moveStatusOfEnemies==false){
        [enemydesx,enemydesy]=enemyTargetLocation();
        //console.log(enemydesx,enemydesy);
       // moveStatusOfEnemies[i]=true;
    //}
    got=false;
...
function main(){
    ...
    //playerLastLocation=findLastLocation();
   // console.log(playerLastLocation);
    update();
    killPlayer();
    draw();
}
